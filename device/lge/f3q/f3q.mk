...
# Device overlay
DEVICE_PACKAGE_OVERLAYS += device/lge/f3q/overlay
...
ifeq ($(TARGET_BUILD_VARIANT),user)
    NFCEE_ACCESS_PATH := device/lge/f3q/nfc/nfcee_access.xml
else
    NFCEE_ACCESS_PATH := device/lge/f3q/nfc/nfcee_access_debug.xml
endif
PRODUCT_COPY_FILES += \
